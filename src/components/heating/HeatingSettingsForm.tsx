          ...
          <div className="border-t pt-4">
            ...
            <div className="space-y-5">
              <div className="space-y-3">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Hartes SOC-Gate für die Heizung. Fällt die Batterie unter diesen Wert, stoppt die
                  Heizautomatik sofort (<code>strict</code>) oder blockiert neue Aktivierungen
                  (<code>soft</code>). Mikro-Budget nutzt automatisch <strong>diesen Wert + 5 %</strong>
                  als Floor. KI-Vorschläge erscheinen in der Übersicht (Card „Batterie-Reserve").
                </p>
